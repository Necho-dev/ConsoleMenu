#ifndef CONSOLEACTION_CONSOLEGUI_H
#define CONSOLEACTION_CONSOLEGUI_H
#include <windows.h>
#include <iostream>
#include <iomanip>
#include <vector>
    ...
    void showMenu() {
        ...
        while (!isExit) {
            ...
            switch (mouseEvent.dwEventFlags) {
                case mouseMove: {
                    SetConsoleCursorPosition(GetStdHandle(STD_OUTPUT_HANDLE), {0, static_cast<SHORT>(4)});
...
#endif //CONSOLEACTION_CONSOLEGUI_H
